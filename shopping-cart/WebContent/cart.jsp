					...
					<td>
						<form action="order-now" method="post" class="form-inline">
							...
							<div class="form-group d-flex justify-content-between w-50">
								<a class="btn btn-sm btn-decre" href="quentity-inc-dec?action=dec&id=<%=c.getId()%>"><i
									class="fas fa-minus-square"></i></a> <input type="text"
									name="quentity" class="form-control w-50" value="<%=c.getQuentity() %>" readonly>

								<a class="btn btn-sm btn-incre" href="quentity-inc-dec?action=inc&id=<%=c.getId()%>"><i
